...
var grammar = {
    ...
    {"name": "top_level_statement", "symbols": ["theory_definition"], "postprocess": id},
    ...
    {"name": "theory_definition", "symbols": [{"literal":"@"}, {"literal":"theory"}, "__", "identifier", "_", {"literal":"("}, "_", "parameter_list", "_", {"literal":")"}, "_", "code_block"], "postprocess": 
        d => ({
            type: "theory_definition",
            name: d[3],
            parameters: d[7],
            body: d[11],

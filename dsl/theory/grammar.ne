...
# theory -> "@theory" _ head _ "begin" _ body _ "end" {% d => ({ theory: { name: d[2] }}) %}

# symbol -> [a-zA-Z_] [0-9a-zA-Z_]:* {% d  => d[0] + d[1].join("") %}
...
top_level_statement
    -> theory_definition   {% id %}
    |  proc_definition  {% id %}
    |  line_comment     {% id %}

theory_definition
    -> "@" "theory" __ identifier _ "(" _ parameter_list _ ")" _ code_block
        {%
            d => ({
